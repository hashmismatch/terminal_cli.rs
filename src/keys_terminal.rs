                ...
                match self.buffer.get(1).cloned() {
					Some(0x5B) => {
						match self.buffer.get(2).cloned() {
							Some(0x41) => {
                                Ok(Key::Arrow(Direction::Up))
                            },
                            Some(0x42) => {
                                Ok(Key::Arrow(Direction::Down))
                            },
                            Some(0x43) => {
                                Ok(Key::Arrow(Direction::Right))
                            },
                            Some(0x44) => {
                                Ok(Key::Arrow(Direction::Left))
                            },
...
fn test_escape_sequences() {
    {
        ...
        assert_eq!(Ok(Key::Arrow(Direction::Up)), decoder.decode(65));
    }
}